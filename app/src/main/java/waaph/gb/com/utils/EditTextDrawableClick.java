...
public class EditTextDrawableClick extends AppCompatEditText {
    ...
    public EditTextDrawableClick(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableLeft != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener
                            .onClick(DrawableClickListener.DrawablePosition.LEFTT);
            ...
            if (drawableRight != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener
                            .onClick(DrawableClickListener.DrawablePosition.RIGHTR);
                    event.setAction(MotionEvent.ACTION_CANCEL);
                    return false;
                }
                return super.onTouchEvent(event);
    ...
    public interface DrawableClickListener {
        ...
        public static enum DrawablePosition { TOP, BOTTOM, LEFTT, RIGHTR };
